...
require("cgs.php");
$cgs_obj = new CGS;
$insres = $cgs_obj->conductCert($res['htno'],$res['stname'],$res['fname'],$res['gender'],$res['class'],$_POST['period'],$_SESSION['cert_user']);
      ...
      <div class="col-xs-12 col-sm-9">
        ...
        <div class="panel panel-info dontprint">
          ...
          <div class="panel-body">
            ...
            <div class="row doprint" STYLE=" margin:1mm 1mm 1mm 1mm; border: 5px double #000000; width:185mm; height:145mm;">
              <div class="col-sm-12" style="font-family:'Book Antiqua';">
                <div align='center' style=" padding-top:10px; letter-spacing:1px; font-weight: bold;">
                  ...
                  <span class="data" style="font-family:'Arial'; font-size:1.4em; margin-bottom:12px; letter-spacing: 3px;">CONDUCT CERTIFICATE</span><br/>
                </div>
                <br/>

				<table style=" line-height:2.2em; width:100%;">

				  <tr>
				    <td  style="font-size:1.4em;">&emsp;&emsp;Name of the Student</td>
					<td>:&emsp;&emsp; <?php echo '<span ">'.$g1.' '.$res['stname'].'</span>'; ?></td>
				  </tr>
				  <tr>
				    <td style="font-size:1.4em;">&emsp;&emsp;Admisson Number&emsp;&emsp;</td>
					<td>:&emsp;&emsp;<?php echo '<span ">'.$res['htno'].'</span>'; ?></td>
				  </tr>
				   <tr>
				    <td style="font-size:1.4em;">&emsp;&emsp;Class of Study&emsp;&emsp;</td>
					<td>:&emsp;&emsp;<?php echo '<span ">'.$res['class'].'</span>'; ?></td>
				  </tr>
				   <tr>
				    <td style="font-size:1.4em;">&emsp;&emsp;Period of Study</td>
					<td>:&emsp;&emsp;<b><?php echo $res['period']; ?></b></td>
				  </tr>
				   <tr>
				    <td style="font-size:1.4em;">&emsp;&emsp;Conduct</td>
					<td>:&emsp;&emsp;________________________________________________</td>
				  </tr>
				   <tr>
				    <td style="font-size:1.4em;">&emsp;&emsp;General Remarks</td>
            ...
            <div class="row doprint" STYLE=" margin:1mm 1mm 1mm 1mm; border: 5px double #000000; width:185mm; height:110mm;">
              <div class="col-sm-12" style="font-family:'Book Antiqua';">
                <div align='center' style=" padding-top:10px; letter-spacing:1px; font-weight: bold;">
                  ...
                  <span style="font-size:1em; padding-top:10px;">ANDHRA PRADESH, INDIA - 515002</span><br/>
                  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<img src="images/jntuacea.png" alt="JNTUACEA" width="70px" height="70px" style="margin:10px;" />&emsp;&emsp;&emsp;&emsp; Office Copy(Date:<?php echo date("d/m/Y"); ?>) <br/>
            ...
            <tr>
            <td  style="font-size:1.1em;">&emsp;&emsp;Name of the Student&emsp;&emsp;</td>
