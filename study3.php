...
if(!empty($_POST['htno']) && !empty($_POST['stname']) && !empty($_POST['fname']) && !empty($_POST['mname']) && !empty($_POST['gender']) && (!empty($_POST['year']) || !empty($_POST['sem'])) && !empty($_POST['course']) && !empty($_POST['spec']) && empty($_POST['purpose'])){



$x=$_POST['doj'];
$_SESSION['y']=$x[6].$x[7].$x[8].$x[9];
$res = $_POST;
  require('header.php');
  ?>
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" action="study4.php" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <?php echo $x."-".$_POST['mnth']."/". $_POST['end']; ?>
                    </div>
                    <div class="col-sm-3">
                      &nbsp;
                    </div>
                ...
                <input type='hidden' name='period' value='<?php echo $x." - ".$_POST['mnth']." ".$_POST['end']; ?>' />
				  <input type='hidden' name='end' value='<?php echo $_POST['end']; ?>' />
                  <div class="form-group">
                    <div class="col-sm-4" align='right'>
                      <a href="study1.php" class="btn btn-danger">&nbsp;&nbsp;Abort&nbsp;&nbsp;</a>
                    </div>
