...
if(empty($res['status']) || $res['status']==0){
  header('Location: coursec1.php?res=nohtno');
}
else{
  require('header.php');
  ?>
      ...
      <div class="col-xs-12 col-sm-9">
        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" action="coursec3.php" method="post">
           ...
           <input type='hidden' name='strt' value='<?php echo $st ?>' />
              ...
              <div class="form-group">
                <div class="col-sm-4" align='right'>
                  <a href="coursec1.php" class="btn btn-danger">&nbsp;&nbsp;Abort&nbsp;&nbsp;</a>
                </div>
