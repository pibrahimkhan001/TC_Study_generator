...
require("cgs.php");
$cgs_obj = new CGS;
$insres = $cgs_obj->studyCert($res['htno'],$res['stname'],$res['fname'],$res['gender'],$res['class'],$_POST['period'],$res['purpose'],$_SESSION['cert_user']);
              ...
              <div class="col-sm-12" style="font-family:'Book Antiqua'; border: 2px solid #000000; ">
                ...
                <div style="text-align:justify;-moz-text-align:justify; line-height:2.4em;">
                  <p  style="font-family:'Book Antiqua'; font-size:1.2em;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <?php echo '<span class="data">'.$g1.' '.$res['stname'].'</span>'; ?> (Adm. No. <?php echo '<span class="data">'.$res['htno'].'</span>'; ?>) <?php echo $g2.' of <span class="data">Sri '.$res['fname'].'</span>'; ?>
                     was a bonafide student of this Institution studied <?php echo '<span class="data">'.$res['class'].'</span>'; ?> class during the period <?php echo $res['period']; ?>. This certificate is issued to <?php echo $g3; ?> on <?php echo $g4; ?> request to apply for "<?php echo '<span class="datapurpose">'.$res['purpose'].'</span>'; ?>".</p>
                </div>
