...
if(!empty($_POST['htno']) && !empty($_POST['stname']) && !empty($_POST['fname']) && !empty($_POST['mname']) && !empty($_POST['gender']) && (!empty($_POST['year']) || !empty($_POST['sem'])) && !empty($_POST['course']) && !empty($_POST['spec']) && !empty($_POST['period']) 
	&& !empty($_POST['adate'])&& !empty($_POST['ldate'])&& !empty($_POST['appdate']) && !empty($_POST['qualify'])&& !empty($_POST['pay'])&& !empty($_POST['medical'])&& !empty($_POST['nationality'])){
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" action="tc4.php" method="post">
                  ...
                  <div class="form-group">
				   ...
				   <div class="form-group">
                    <label for="inputHtno" class="col-sm-6 control-label labelapply3">Date of Leavving:</label>
                    <div class="col-sm-3">
                      <?php echo $_POST['ldate']; ?>
                    </div>
                    <div class="col-sm-3">
                      &nbsp;
                    </div>
				   ...
				   <div class="form-group">
                    <label for="inputHtno" class="col-sm-6 control-label labelapply3">Qualified to Next Class:</label>
                    <div class="col-sm-3">
                      <?php echo $_POST['qualify']; ?>
                    </div>
                    <div class="col-sm-3">
                      &nbsp;
                    </div>
				   ...
				   <div class="form-group">
                    <label for="inputHtno" class="col-sm-6 control-label labelapply3">Paid All College Due:</label>
                    <div class="col-sm-3">
                      <?php echo $_POST['pay']; ?>
                    </div>
                    <div class="col-sm-3">
