...
require("cgs.php");
$cgs_obj = new CGS;
$insres = $cgs_obj->studyCert($res['htno'],$res['stname'],$res['fname'],$res['gender'],$res['class'],$_POST['period'],$_SESSION['cert_user']);
...
if($res['gender']=='M'){
      ...
      <div class="col-xs-12 col-sm-9">
        ...
        <div class="panel panel-info dontprint">
          <div class="panel-heading">
            <h4 align='center'>Study Certificate Generation</h4>
          </div>

          <div class="panel-body">
            <form class="form-horizontal" role="form" action="study4.php" method="post">
                  ...
                  <div class="form-group">
                    <div class="col-sm-4" align='right'>
                      <a href="study1.php" class="btn btn-default">&nbsp;&nbsp;Back&nbsp;&nbsp;</a>
                    </div>
                  ...
                  <br/>
                  <div class="col-sm-12" align='center'>
                    <span style="color:red"> Please Contact Administrator with ErrorName 'StudyNotInserted' </span>
                  </div>
                  <?php } ?>
 ...
 <div class="row doprint" STYLE=" margin:5mm 5mm 5mm 5mm; border: 5px double #000000; width:185mm; height:145mm;">
              <div class="col-sm-12" style="font-family:'Book Antiqua'; ">
                <div align='center' style=" padding-top:12px; letter-spacing:1px; font-weight: bold;">
                  ...
                  <span class="data" style="font-family:'Arial'; font-size:1.4em; margin-bottom:12px; letter-spacing: 3px;">STUDY CERTIFICATE</span>
                </div>
                           <br/>   <div style="text-align:justify;-moz-text-align:justify; line-height:2.4em;">
                  <p  style="font-family:'Book Antiqua'; font-size:1.2em;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <?php echo '<span class="data">'.$g1.' '.$res['stname'].'</span>'; ?> (Adm. No. <?php echo '<span class="data">'.$res['htno'].'</span>'; ?>) <?php echo $g2.' of <span class="data">Sri '.$res['fname'].'</span>'; ?>
                     was a bonafide student of this Institution studied <?php echo '<span class="data">'.$res['class'].'</span>'; ?> course during the period <?php echo $_POST['period']; ?>. </p>
                </div>
				<div  style="padding-right:15px; font-weight: bold; font-size:1.1em;">
        </br>
			<br>

                 &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;PRINCIPAL
                </div>
              </div>
            </div>
