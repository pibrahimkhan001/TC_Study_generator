...
require('header.php');
 ...
 $obj = new CGS();
 $ke=$obj->updtc($_POST['htnou'],$_POST['snameu'],$_POST['genderu'],$_POST['fnameu'],$_POST['mnameu'],$_POST['yearu'],$_POST['semu'],$_POST['doju'],$_POST['dobu'],$_POST['casteu'],$_POST['subcasteu'],$_POST['castenameu'],$_POST['religionu'],$_POST['nationalityu']);
 if(!empty($ke)){
   ?>
      ...
      <div class="col-xs-12 col-sm-9">
        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body">
			...
			<div class="form-group">
              <label for="inputHtno" class="col-sm-6 control-label labelapply3" >Sub Caste:</label>
              <div class="col-sm-6">
                <?php echo $ke['subcaste']; ?>
              </div>
            </div>
